...
#cursor.execute("""  UPDATE `Encab_NDCFact` SET Fenc_EstadoProceso = 0, Fenc_Resultado = 0, Fenc_Pdf = 0, Fenc_EnviadoCorreo = 0 WHERE Fenc_Fecha_Factura > 17/7/2020 """, )
#conn.commit()
conn.autocommit = True
cursor.execute(""" UPDATE FACTURA_ENCABEZADO SET Fenc_EstadoProceso = 0, Fenc_Resultado = 0, Fenc_Pdf = 0, Fenc_EnviadoCorreo = 0  WHERE Fenc_Fecha_Factura > #7/17/2020# """, )
#conn.commit()            